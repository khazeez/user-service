...
const file_user_proto_rawDesc = "" +
	...
	"\x05users\x18\x01 \x03(\v2\x12.user.UserResponseR\x05users2\xe3\x01\n" +
	"\vUserService\x129\n" +
	"\n" +
	...
	"\tListUsers\x12\v.user.Empty\x1a\x16.user.UserListResponse\x122\n" +
	"\n" +
...
var file_user_proto_depIdxs = []int32{
	...
	5, // 7: user.UserService.ListUsers:output_type -> user.UserListResponse
